...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        ‍<title>ctez</title>‍
        <meta name="description" content="ctez application" />‍
      </Helmet>
        ...
        <Flex alignItems="center" flexDirection={largerScreen ? 'row' : 'column'}>
          ...
          >
            ...
            <Text opacity="0.5" color={textcolor} fontSize="md" pr={15}>
              ctez is a collateralized version of tez allowing you to use Tezos DeFi and delegate
              your tez simultaneously.
            </Text>
            <HStack
              mt={10}
